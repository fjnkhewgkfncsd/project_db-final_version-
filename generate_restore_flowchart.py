...
"""
    ...
    try:
        ...
        print(f"✅ Complete restore flow documentation saved to: {output_file}")
        print(f"📄 File size: {len(complete_doc.encode('utf-8'))} bytes")
        print(f"📋 Contains: ASCII flowchart, detailed steps, quick reference, and troubleshooting")
...
"""
        ...
        print(f"✅ Quick reference summary saved to: {summary_file}")
